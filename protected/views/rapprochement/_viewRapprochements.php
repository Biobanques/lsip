...
<div class="view" id="<?php echo $data->idRapprochement; ?>" style="background-color :<?php echo ($data->ratio == 100) ? 'chartreuse' : ($data->ratio >= 75 && $data->ratio < 100 ? 'orange' : 'red'); ?>">



    <h3>Status : <?php echo $data->validated == 1 && $data->validated != NULL ? 'Annulé' : (($data->validated == 0 || $data->validated == NULL) ? 'En attente' : 'Validé'); ?></h3>

    <h3>Taux de correspondance : <?php echo $data->ratio; ?>%</h3>
