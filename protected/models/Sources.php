...
class Sources extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('admin, webapp', 'numerical', 'integerOnly'=>true),
			array('name, passphrase', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, passphrase, admin, webapp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'webapp0' => array(self::BELONGS_TO, 'Users', 'webapp'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('webapp',$this->webapp);
